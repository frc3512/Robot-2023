...
import frc3512.lib.swervelib.math.SwerveMath;
...
public class SwerveModuleConfiguration {
  ...
  public SimpleMotorFeedforward createDriveFeedforward() {
    ...
    double ka =
        physicalCharacteristics.optimalVoltage
            / SwerveMath.calculateMaxAcceleration(
  ...
  public double getPositionEncoderConversion(boolean isDriveMotor) {
    return isDriveMotor
        ? SwerveMath.calculateMetersPerRotation(
            physicalCharacteristics.wheelDiameter, physicalCharacteristics.driveGearRatio)
        : SwerveMath.calculateDegreesPerSteeringRotation(physicalCharacteristics.angleGearRatio);
  }
}
