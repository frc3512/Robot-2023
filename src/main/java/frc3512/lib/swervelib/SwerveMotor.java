...
import frc3512.lib.swervelib.motors.CTRESwerveMotor;
import frc3512.lib.swervelib.motors.REVSwerveMotor;
...
public abstract class SwerveMotor {
  ...
  /**
   * Constructor for Swerve Motor, expecting CANSparkMax or TalonFX. Clears sticky faults and
   ...
   */
  public static <MotorType extends MotorController> SwerveMotor fromMotor(
      MotorType motor,
