...
import frc3512.lib.swervelib.encoders.CTRECANCoder;
import frc3512.lib.swervelib.encoders.PWMAnalogEncoder;
import frc3512.lib.swervelib.encoders.PWMDutyCycleEncoder;
import frc3512.lib.swervelib.encoders.REVAbsoluteEncoder;
...
public abstract class SwerveEncoder<AbsoluteEncoderType> {
   ...
   * @param <AbsoluteEncoderType> One of DutyCycleEncoder, AnalogEncoder, AbsoluteEncoder, and
   *     CANCoder
