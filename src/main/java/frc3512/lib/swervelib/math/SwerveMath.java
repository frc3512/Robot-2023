...
import frc3512.lib.swervelib.SwerveController;
...
public class SwerveMath {
  ...
  private static double calcMaxAccel(
    ...
    SpartanDoubleEntry entry =
        new SpartanDoubleEntry("/Diagnostics/Swerve/Physical Values/Max Acceleration");
    entry.set(maxAccel);
    return maxAccel;
  }
  ...
  public static Translation2d limitVelocity(
    ...
    SpartanDoubleEntry velocityEntry =
        new SpartanDoubleEntry("/Diagnostics/Swerve/Physical Values/Current Velocity");
    velocityEntry.set(currentVelocity.getX());
    ...
    SpartanDoubleEntry deltaVEntry =
        new SpartanDoubleEntry("/Diagnostics/Swerve/Physical Values/Delta V Entry");
    deltaVEntry.set(deltaV.getX());
